...
const page5Text = document.querySelector(".page5-text");
const page5TextH1 = document.querySelectorAll(".page5-text>h1");
page5Text.addEventListener("mouseenter", () => {
  page5TextH1.forEach((h1) => {
    gsap.to(h1, {
      y: -145,
    });
  });
...
page5Text.addEventListener("mouseleave", () => {
  page5TextH1.forEach((h1) => {
    gsap.to(h1, {
      y: 0,
    });
...
const page6Text = document.querySelector(".page6-text");
const page6TextH1 = document.querySelectorAll(".page6-text>h1");
page6Text.addEventListener("mouseenter", () => {
  page6TextH1.forEach((h1) => {
    gsap.to(h1, {
      y: -180,
    });
  });
});
page6Text.addEventListener("mouseleave", () => {
  page6TextH1.forEach((h1) => {
    gsap.to(h1, {
      y: 0,
    });
